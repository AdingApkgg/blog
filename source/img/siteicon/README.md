...
Insert the following code in the `head` section of your pages:
    ...
    <link rel="mask-icon" href="/img/siteicon/safari-pinned-tab.svg" color="#f4a460">
    <link rel="shortcut icon" href="/img/siteicon/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="Asuna's Blog">
    <meta name="application-name" content="Asuna's Blog">
    <meta name="msapplication-TileColor" content="#f4a460">
